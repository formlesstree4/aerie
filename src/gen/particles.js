...
(function (EmitterType) {
    EmitterType[EmitterType["Campfire"] = 0] = "Campfire";
    EmitterType[EmitterType["Explosion"] = 1] = "Explosion";
    EmitterType[EmitterType["Smoke"] = 2] = "Smoke";
    EmitterType[EmitterType["Sparks"] = 3] = "Sparks";
    EmitterType[EmitterType["Fireworks"] = 4] = "Fireworks";
    EmitterType[EmitterType["Magic"] = 5] = "Magic";
})(EmitterType || (EmitterType = {}));
export const EMITTER_LABELS = {
...
export function defaultEmitter(type) {
    const base = {
        type,
...
function evalOne(e, j, t, col, out2) {
...
export function evaluateEmitter(e, t, out, off) {
    const col = [0, 0, 0];
    const out2 = [0, 0];
