import { WebGLRenderer, Scene as ThreeScene, PerspectiveCamera, DirectionalLight, HemisphereLight, Mesh, PlaneGeometry, MeshStandardMaterial, Color, Fog, AnimationMixer, Clock, MathUtils, } from "three";
...
export class Preview {
    ...
    constructor(canvas, app) {
        ...
        const ground = new Mesh(new PlaneGeometry(4000, 4000), new MeshStandardMaterial({ color: 0x5b6b45, roughness: 1 }));
